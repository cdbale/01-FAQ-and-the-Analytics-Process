...
<div>
![](Figures/rebecca_headshot.jpg){width=300px}
</div>

<div>
![](Figures/vincent_headshot.jpg){width=300px}
</div>
...
<div>
![](Figures/lark_headshot.jpeg){width=300px}
</div>

<div>
![](Figures/ethan_headshot.jpeg){width=300px}
</div>
...
To answer that, we first need to understand what [coding ACTUALLY is](https://www.youtube.com/shorts/twYMcd9cVxI)...
...
- You complete a (semi) open-ended task typically with some specific steps along the way.
- You complete a Knowledge check independently, but risk is very low **if you are present**
